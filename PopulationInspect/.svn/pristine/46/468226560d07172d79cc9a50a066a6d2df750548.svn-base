...
function admin() {
    ...
    p += '欢迎您！<span>' + policeInfo.poliName + '&nbsp;[<i class="num blue b">' + policeInfo.poliCode + '</i>]</span>巡检提醒（<i id="over-due" class="num red-2 b"><a class="num red-2" href="javascript:void(0)"></a>/<a class="num red-2" href="javascript:void(0)"></a>/<a class="num red-2" href="javascript:void(0)"></a></i>）'
    p += '</ul><ul class="admin-web">';
    p += '上一次登陆：<span>' + policeInfo.timeLastlogin + '&nbsp;&nbsp;[<i class="blue b">' + policeInfo.ipLastlogin + '</i>]</span></ul>';
    adminbox.html(p);

    getOverDue(policeInfo.poliId);
}
//admin(datas);
